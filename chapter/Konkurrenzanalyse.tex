...
Thema zu durchsuchen. Ohne das Vorwissen, dass die drei Seiten dies anbieten, ist diese Dienstleistung allerdings nicht auf den ersten
Blick erkenntlich.
\begin{figure}[h]
    \centering
    \includegraphics{Google Startseite}
    \caption{Startseite von Google}
\end{figure}
...
Suchmaschinen an Selbstbeschreibungsfähigkeit. Dies wäre nur gewährleistet, „wenn jeder einzelne Dialogschritt unmittelbar
verständlich ist“\autocite[Seite 6]{Maulhardt.20220506}. Auch adäquate Anleitungen werden nicht zur Verfügung gestellt.
...
\begin{figure}[h]
    ...
    \caption{Einstellungen von Google}
\end{figure}
