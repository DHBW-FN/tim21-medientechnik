...
\newcommand{\vAutor}{Tobias Goetz - 4143507\\Philip Kuest - 3655862\\Noel Kempter - 2478267\\Marius Frick - }                           %% Vorname Nachname
...
\begin{document}
    ...
    \include{chapter/Konkurrenzanalyse}
    \include{chapter/Googlestrategie}
    \include{chapter/Qwant-erfolg}
    \include{chapter/4_Finanzierungskonzepte}
    \include{chapter/UsabilityTest}
    \include{chapter/6_EinflussVonGoogle}
