...
\newcommand{\vUntertitel}{Einzelaufgabe}                      %%
...
\newcommand{\vAutor}{Tobias Goetz}                           %% Vorname Nachname
\newcommand{\vMatrikelnummer}{4143507}                  %% 7-stellige Zahl
...
\newcommand{\vBetrieb}{KION IoT Systems GmbH}                         %%
\newcommand{\vBearbeitungsort}{Wangen}                 %%
...
%  \include{chapter/Einleitung}
  \include{chapter/UsabilityTests}
